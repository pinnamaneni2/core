...
public class CollectionExamples {
	public static void main(String[] args) {
		...
		Hashtable<String, Cricketer> hashmap = new Hashtable<String, Cricketer>();

		hashmap.put("sachin", new Cricketer("Sachin", 14000));
		//System.out.println(hashmap.put(null, new Cricketer("Sachin", 14000)));
		...
		Set<Entry<String, Cricketer>> entrySet = hashmap.entrySet();
		System.out.println("-------------------");
		entrySet.forEach(System.out::println);
		System.out.println("-------------------");
		Iterator<Entry<String, Cricketer>> iterator = entrySet.iterator();
		...
		//System.out.println(hashmap.put(null, "value"));
